...
! function(t, e) {
  ...
  var v, x, y, F, w, V, N, b, O, k, A, C = h.getByTarget,
      ...
      B = function(t) {
          ...
          // Temporarely disable plugin check to allow plugin to be run on internal dev hosts.
          // This is for showcase only and CANNOT be used in production!
          // Join GSAP club to purchase this plugin: https://greensock.com/inertia/
